    ...
    <div class="main">
        <table  class="gridtable">
            <tr>
                ...
                <th width="7%">Current Salary</th>
                <th width="7%">Expected Salary</th>          
            ...
            <tr id="${personnel.personnel_id}" >
               ...
               <td>${personnel.nick_name}</td>
               <td>
                   <c:if test="${personnel.sex ==0 }">Male</c:if>
                   <c:if test="${personnel.sex ==1}">Femal</c:if>
               </td>
               
               <td>${personnel.email}</td>
               <td>${personnel.mobile}</td>
               <td>${personnel.mobile2}</td>
               ...
               <td title=" ${personnel.reminder}">
                 <c:if test="${fn:length(personnel.reminder) > 10}">  
                        ${fn:substring(personnel.reminder, 0, 10)}...
                 </c:if>  
                 <c:if test="${fn:length(personnel.reminder) <= 10}">  
                         ${personnel.reminder}
                 </c:if>  
